 ...
 */
public class MMNEATCrossover extends NEATCrossover {
     ...
     */
    private MMNEATGenome favorParent(Random rnd, MMNEATGenome mom, MMNEATGenome dad) {
    ...
    public void performOperation(Random rnd, Genome[] parents, int parentIndex, Genome[] offspring,
        ...
        final MMNEATGenome mom = (MMNEATGenome) parents[parentIndex];
        final MMNEATGenome dad = (MMNEATGenome) parents[parentIndex + 1];

        final MMNEATGenome best = favorParent(rnd, mom, dad);
        final MMNEATGenome notBest = (best != mom) ? mom : dad;
